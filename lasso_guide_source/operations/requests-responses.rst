...
.. method:: headers()::trait_forEach
.. method:: header(name::string)
.. method:: rawHeader(name::string)
...
.. method:: queryParam(name::string)
.. method:: postParam(name::string)
.. method:: param(name::string)
.. method:: param(name::string, joiner)
.. method:: queryParams()
.. method:: postParams()
.. method:: params()
...
.. method:: cookie(named::string)
.. method:: cookies()::trait_forEach
...
.. method:: includeOnce(path::string)
.. method:: includeLibrary(path::string)
.. method:: includeLibraryOnce(path::string)
...
.. method:: setHeaders(headers::trait_forEach)
.. method:: replaceHeader(header::pair)
.. method:: addHeader(header::pair)
...
.. method:: setCookie(nv::pair, -domain=void, -expires=void, -path=void, -secure=false)
...
.. method:: sendFile(data::trait_each_sub, name = null, 
...
.. method:: setStatus(code::integer, msg::string)
.. method:: getStatus()::pair
