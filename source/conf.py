...
# sphinx-quickstart on Mon Feb  8 20:06:09 2016.
#
...
project = 'LassoGuide'
copyright = '%s, LassoSoft Inc.' % time.strftime('%Y')
author = 'LassoSoft Inc.'
...
pygments_style = 'trac' # or manni, tango, autumn
...
texinfo_documents = [
    (master_doc, 'LassoGuide', project,
     author, 'LassoGuide', 'Guide to the Lasso language and server.',
     'Miscellaneous'),
]
